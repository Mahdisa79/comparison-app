    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('admin-assets/assets/plugins/font-awesome/css/font-awesome.min.css') }}">

	<!-- BOOTSTRAP CSS -->
	<link id="style" href="{{asset("admin-assets/assets/plugins/bootstrap/css/bootstrap.min.css")}}" rel="stylesheet" />

	<!-- BOOTSTRAP RTL CSS -->
	<link id="style" href="{{asset("admin-assets/assets/plugins/bootstrap/css/bootstrap.rtl.min.css")}}" rel="stylesheet" />
