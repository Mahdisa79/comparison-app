                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <div class="main-header-center ms-3 d-none d-xl-block">
                            <input class="form-control" placeholder="جستوجو ..." type="search">
                            <button class="btn">
										...
										<div class="dropdown d-md-flex message">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
												...
												<div class="message-menu ps2 overflow-hidden">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset("admin-assets/assets/images/users/12.jpg")}}" style="background: url({{asset("admin-assets/assets/images/users/12.jpg")}}) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset("admin-assets/assets/images/users/4.jpg")}}" style="background: url({{asset("admin-assets/assets/images/users/4.jpg")}}) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
